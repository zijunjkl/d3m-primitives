...
from rpi_d3m_primitives.NaiveBayes import NaiveBayes as NB
from rpi_d3m_primitives.TreeAugmentNB import TreeAugmentNB
...
hyperparams_class = NB.metadata.query()['primitive_code']['class_type_arguments']['Hyperparams']
classifier = NB(hyperparams=hyperparams_class.defaults())
...
dataset.metadata = dataset.metadata.add_semantic_type(('0', metadata_base.ALL_ELEMENTS, 30), 'https://metadata.datadrivendiscovery.org/types/Target')
dataset.metadata = dataset.metadata.add_semantic_type(('0', metadata_base.ALL_ELEMENTS, 30), 'https://metadata.datadrivendiscovery.org/types/TrueTarget')
