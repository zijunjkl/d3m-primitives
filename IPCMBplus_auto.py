...
class IPCMBplus_auto(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    A primitive which selects a set of features condition on which the target is independent of other features. An implementation of "identity parent-children markov blanket discovery" method. Hyper-parameter is selected via a bisection search and there is no hyper-parameter to tune.
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        'source': {
            ...
            'uris': [
                'https://github.com/zijun-rpi/d3m-primitives/blob/master/IPCMBplus_auto.py',
        ...
        'python_path': 'd3m.primitives.feature_selection.identity_parentchildren_markov_blanket.AutoRPI',
        'algorithm_types': [
