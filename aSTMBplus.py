...
class Hyperparams(hyperparams.Hyperparams):
    threshold = hyperparams.Hyperparameter[Union[int, float]](
        default=0.02,
        description="A non-negtive threshold for independence test using mutual information. The number of selected features will be larger if the hyper-parameter is closer to zero.",
...
class aSTMBplus(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    A primitive which selects a set of features condition on which the target is independent of other features. Adaptive mutual information method is applied for independence test.
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        'source': {
            ...
            'uris': [
                'https://github.com/zijun-rpi/d3m-primitives/blob/master/aSTMBplus.py',
        ...
        'python_path': 'd3m.primitives.feature_selection.adaptive_simultaneous_markov_blanket.ManualRPI',
        'algorithm_types': [
