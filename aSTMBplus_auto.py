...
class aSTMBplus_auto(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    A primitive which selects a set of features condition on which the target is independent of other features. Adaptive mututal information method is applied for independence test. Hyper-parameter is selected via a bisection search and there is no hyper-parameter to tune.
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        'source': {
            ...
            'uris': [
                'https://github.com/zijun-rpi/d3m-primitives/blob/master/aSTMBplus_auto.py',
        ...
        'python_path': 'd3m.primitives.feature_selection.adaptive_simultaneous_markov_blanket.AutoRPI',
        'algorithm_types': [
